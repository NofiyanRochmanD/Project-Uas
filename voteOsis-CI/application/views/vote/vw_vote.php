...
<nav>
    <div class="nav-wrapper">
      <a href="#!" class="brand-logo right"><img style="height:60px;" src="<?php echo base_url('assets/img/logo.png'); ?>" ></a>
  ...
  <div class="custom">
    <div class="card">
     ...
     <div class="card-content">
       <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['ketua1']; ?><i class="material-icons right"></i></span>
...
<div class="custom">
  <div class="card">
   ...
   <div class="card-content">
     <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['ketua2']; ?><i class="material-icons right"></i></span>
...
<div class="custom">
  <div class="card">
   ...
   <div class="card-content">
     <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['ketua3']; ?><i class="material-icons right"></i></span>
...
<div class="custom0" id="wakil" style="display:none;">
  <div class="custom">
    <div class="card">
     ...
     <div class="card-content">
       <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['wakil1']; ?><i class="material-icons right"></i></span>
...
<div class="custom">
  <div class="card">
   ...
   <div class="card-content">
     <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['wakil2']; ?><i class="material-icons right"></i></span>
   ...
   <div class="card-reveal">
     ...
     <p><?php echo $info_calon['wakil2']; ?></p>
   </div>
 </div>
</div>
...
<div class="custom">
  <div class="card">
   ...
   <div class="card-content">
     <span class="card-title activator grey-text text-darken-4"><?php echo $nama_calon['wakil3']; ?><i class="material-icons right"></i></span>
...
<a id="pilih_ketua" class="waves-effect waves-light btn" style="position:center;"><i class="material-icons right"></i>pilih ketua</a>
<a id="pilih_wakil" class="waves-effect waves-light btn" style="display:none;"><i class="material-icons right"></i>pilih wakil</a>
</div>
</div>
  <script>
